...
public class FileIO {
	...
	public void setWritePath(String path) {
		this.setWritePath(new File(path), "UTF-8", true);
	}

	public void setWritePath(String path, String charset) {
		this.setWritePath(new File(path), charset, true);
	}
	
	public void setWritePath(String path, boolean isAppend) {
		this.setWritePath(new File(path), "UTF-8", isAppend);
	}

	public void setWritePath(File file, String charset, boolean isAppend) {
		try {
			this.closeWriter();
